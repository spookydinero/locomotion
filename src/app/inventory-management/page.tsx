        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a className="text-sm font-medium text-primary" href="/inventory-management">Inventory</a>
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col gap-8">
          <div>
            ...
            <p className="text-subtext-light dark:text-subtext-dark mt-1">Welcome back, Alex. Manage your inventory here.</p>
          </div>
          ...
          <div className="border-b border-border-light dark:border-border-dark">
            <nav className="flex space-x-8">
              <a href="#" className="text-primary font-semibold border-b-2 border-primary pb-2">Fast-Movers</a>
              <a href="#" className="text-subtext-light dark:text-subtext-dark hover:text-text-light dark:hover:text-text-dark pb-2">All Parts</a>
              <a href="#" className="text-subtext-light dark:text-subtext-dark hover:text-text-light dark:hover:text-text-dark pb-2">Suppliers</a>
            </nav>
          </div>
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-border-light dark:divide-border-dark">
                <thead className="bg-background-light dark:bg-background-dark">
                  <tr>
                    <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-text-light dark:text-text-dark sm:pl-6">
                      SKU
                    </th>
                    <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-text-light dark:text-text-dark">
                      Name
                    </th>
                    <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-text-light dark:text-text-dark">
                      On-Hand
                ...
                <tbody className="divide-y divide-border-light dark:divide-border-dark bg-surface-light dark:bg-surface-dark">
                  <tr>
                    <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-text-light dark:text-text-dark sm:pl-6">
                      SKU123
                    </td>
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-subtext-light dark:text-subtext-dark">
                      Brake Pads
                    </td>
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-subtext-light dark:text-subtext-dark">
                      10
                  ...
                  <tr className="bg-warning/10">
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-warning font-semibold">
                    ...
                    <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                      <button className="bg-primary text-white px-3 py-1 rounded-md text-sm font-semibold">Reorder</button>
                    </td>
                  </tr>
                  ...
                  <tr className="bg-danger/10">
                    ...
                    <td className="whitespace-nowrap px-3 py-4 text-sm text-danger font-semibold">
                      <div className="flex items-center gap-2">
