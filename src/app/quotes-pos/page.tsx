...
export default function QuotesAndPOsPage() {
  return (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <nav className="hidden md:flex items-center space-x-8">
              ...
              <a className="text-sm font-medium text-primary" href="/quotes-pos">Quotes & POs</a>
      ...
      <main className="flex-grow container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex flex-col gap-8">
          <div>
            ...
            <p className="text-subtext-light dark:text-subtext-dark mt-1">Welcome back, Alex. Compare quotes here.</p>
            <p className="text-subtext-light dark:text-subtext-dark mt-1">Work Order: WO-1001 - Toyota Camry</p>
          </div>

          <section>
              <h2 className="text-xl font-bold mb-4">Part: Brake Pads</h2>
              <div className="rounded-lg border border-border-light dark:border-border-dark bg-surface-light dark:bg-surface-dark overflow-hidden">
                <div className="overflow-x-auto">
                  <table className="w-full text-sm text-left">
                    <thead className="bg-background-light dark:bg-background-dark text-xs uppercase text-subtext-light dark:text-subtext-dark">
                      <tr>
                        <th className="px-6 py-3 font-medium" scope="col">Vendor</th>
                        <th className="px-6 py-3 font-medium" scope="col">Price</th>
                        <th className="px-6 py-3 font-medium" scope="col">ETA</th>
                        <th className="px-6 py-3 font-medium" scope="col">Warranty</th>
                        <th className="px-6 py-3 font-medium" scope="col">Brand</th>
                        <th className="px-6 py-3 font-medium text-right" scope="col">Action</th>
                      </tr>
                    </thead>
                    <tbody>
                      <tr className="border-b border-border-light dark:border-border-dark">
                        <td className="px-6 py-4 font-medium whitespace-nowrap">Auto Parts Inc.</td>
                        <td className="px-6 py-4">$50</td>
                        <td className="px-6 py-4">2 days</td>
                        <td className="px-6 py-4">1 year</td>
                        <td className="px-6 py-4">
                          <span className="px-2 py-1 text-xs font-medium rounded-full bg-primary/10 text-primary dark:bg-primary/20">Premium</span>
                        </td>
                        <td className="px-6 py-4 text-right">
                          <button className="font-semibold text-primary hover:underline">Attach Quote</button>
                        </td>
                      </tr>
                      <tr className="border-b border-border-light dark:border-border-dark bg-background-light dark:bg-background-dark">
                        <td className="px-6 py-4 font-medium whitespace-nowrap">Global Auto Supply</td>
                        <td className="px-6 py-4">$45</td>
                        <td className="px-6 py-4">3 days</td>
                        <td className="px-6 py-4">6 months</td>
                        <td className="px-6 py-4">
                          <span className="px-2 py-1 text-xs font-medium rounded-full bg-primary/10 text-primary dark:bg-primary/20">Standard</span>
                        </td>
                        <td className="px-6 py-4 text-right">
                          <button className="font-semibold text-primary hover:underline">Attach Quote</button>
                        </td>
                      ...
                      <tr className="border-b border-border-light dark:border-border-dark">
                        <td className="px-6 py-4 font-medium whitespace-nowrap">Discount Auto Parts</td>
                        <td className="px-6 py-4">$40</td>
                        <td className="px-6 py-4">1 day</td>
                        <td className="px-6 py-4">3 months</td>
                        <td className="px-6 py-4">
                          <span className="px-2 py-1 text-xs font-medium rounded-full bg-primary/10 text-primary dark:bg-primary/20">Economy</span>
                        </td>
                        <td className="px-6 py-4 text-right">
                          <button className="font-semibold text-primary hover:underline">Attach Quote</button>
                        </td>
            ...
            <div className="flex justify-end gap-4 mt-8">
              <button className="px-6 py-2 rounded-lg border border-border-light dark:border-border-dark text-text-light dark:text-text-dark font-semibold hover:bg-background-light dark:hover:bg-background-dark">
                Cancel
              </button>
              <button className="px-6 py-2 rounded-lg bg-primary text-white font-semibold hover:opacity-90">
